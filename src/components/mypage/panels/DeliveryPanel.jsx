      ...
      >
        <div className="flex justify-between items-center">
          {currentPage === "delivery" ? (
            ...
            <button className="p-4 cursor-pointer" onClick={cancelEdit}>
              <ChevronLeft />
            </button>
          )}
          ...
          <Button
            ...
            variant="link"
            size="icon"
            onClick={() => setCurrentPage("delivery_info")}
          >
        ...
        <ScrollArea className="overflow-y-auto h-full">
          ...
          {currentPage === "delivery" && (
            <Tabs defaultValue="request" className="flex flex-col flex-1">
              ...
              <TabsContent value="request" className="flex-1 px-4 space-y-4">
                ...
                <div className="flex h-[700px]">
                  <Tabs defaultValue="sent" className="flex flex-1 w-full">
                    ...
                    <TabsList className="ml-3 bg-transparent gap-1">
                      <TabsTrigger
                        value="sent"
                        className="cursor-pointer border border-gray-300 text-gray-500 bg-white rounded-full px-3 py-1 h-auto transition-colors
              ...
              <TabsContent value="a" className="flex-1 px-4">
                <div className="space-y-0">
                  ...
                  <div className="py-4 px-4">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      받는 분이 상품을 수령하지 않아 보내는 분에게 반송된 상태
                    </p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="b" className="flex-1 px-4">
                <div className="space-y-0">
                  ...
                  <div className="py-4 border-b px-4">
                    <h4 className="font-semibold text-base">접수완료</h4>
                    <p className="text-sm text-gray-600 mt-1">
                      운송장 번호가 발급된 상태, 편의점 택배 접수 완료, 방문
                      기사님 수거 완료
                    </p>
                  </div>
