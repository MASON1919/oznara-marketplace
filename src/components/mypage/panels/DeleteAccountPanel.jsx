        ...
        <ScrollArea className="overflow-y-auto">
          <div className="mx-4">
            <div className="">
              ...
              <p className="my-5 text-sm text-gray-500">(복합 선택 가능)</p>
            ...
            <div className="text-base text-gray-700">
              ...
              <div className="mt-2 space-y-5 w-full ">
                <div className="flex items-start gap-2">
                  <span className="text-lg font-bold w-6 flex-shrink-0">
                    01
                  </span>
                  <p className="pl-2 flex-1 text-gray-600">
                    탈퇴 신청일로부터 30일 이내에 동일한 아이디와 휴대폰 번호로
                    가입 불가하며 재가입 시, 신규 가입 혜택은 적용되지 않습니다.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="pl-2 flex-1 text-gray-600">
                    회원 탈퇴 시 본인 계정에 등록된 게시물 또는 회원이 작성한
                    게시물 일체는 삭제됩니다. 다만, 다른 회원에 의해 스크랩되어
                    게시되거나 공용 게시판에 등록된 게시물은 삭제되지 않으니
                    삭제를 원하신다면 미리 삭제 후 탈퇴를 진행해주세요.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="pl-2 flex-1 space-y-2 text-gray-600">
                    <p>
                      전자 상거래 등에서의 소비자 보호에 관한 법률 규정에 따라
                      아래와 같이 기록을 보관하며, 법률에 의한 경우 외 다른
                      목적으로 이용되지 않습니다.
                    </p>
                    <ul className="list-disc ml-5 space-y-1">
                      <li>표시 광고에 대한 기록: 6개월</li>
                      <li>
                        계약 또는 청약철회, 대금결제 및 재화 등의 공급에 관한
                        기록: 5년
                      </li>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="pl-2 flex-1 text-gray-600">
                    탈퇴 신청 후 72시간(3일) 이내 동일한 계정으로 로그인 시 탈퇴
                    신청이 자동으로 철회됩니다.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p className="pl-2 flex-1 text-gray-600">
                    중고나라 카페 글쓰기 권한을 받은 상태에서 탈퇴할 경우,
                    중고나라 카페와의 연결이 해제되며 회원 등급도 변경됩니다.
                    이로 인해 카페에서 글쓰기가 제한될 수 있으니 유의해주세요.
                  </p>
                </div>
                ...
                <Button
                  ...
                  disabled={
                    checked.length === 0 ||
                    (checked.includes("etc") && detail.trim().length === 0)
                  }
