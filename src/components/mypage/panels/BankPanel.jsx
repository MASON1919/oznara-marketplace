    ...
    try {
      ...
      if (data.match) {
        setResult({
          ...
          message: `${data.ownerName}님 명의의 계좌가 확인되었어요.`,
        });
      } else {
        setResult({
          status: "mismatch",
          ownerName: data.ownerName,
          message: `등록된 회원 정보와 일치하지 않습니다. (${data.ownerName})`,
        });
      }
    } catch (e) {
      setResult({
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-medium">
                {result.ownerName}님 명의의 계좌가 확인되었어요.
              </div>
        ...
        <div className="mt-3 p-3 rounded-md border border-red-200 bg-red-50">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-sm text-slate-600">
                확인된 계좌 명의: {result.ownerName || "확인 불가"} · 회원명:{" "}
                {userName}
              </div>
            </div>
          </div>
    ...
    <Sheet open={true} onOpenChange={onClose}>
      <SheetContent side="right" className="w-full md:max-w-xl z-[9999]">
        {currentPage === "manage" ? (
          ...
          <button
            className="absolute top-4 left-4 cursor-pointer z-[10000]"
            onClick={cancelEdit}
          >
            <ChevronLeft />
          </button>
              ...
              {registered.length === 0 ? (
                ...
                <ul className="space-y-2">
                  {registered.map((r, idx) => (
                    ...
                    >
                      <span>
                        {r.bankName} • {r.maskedAccount || r.accountNumber}
                      </span>
            ...
            <div className="grid grid-cols-12 gap-3 items-end">
              ...
              <div className="col-span-7">
                ...
                <input
                  ...
                  value={accountNumber}
                  onChange={(e) =>
                    setAccountNumber(formatAccountInput(e.target.value))
                  }
              ...
              <div className="col-span-12 flex gap-2 mt-2">
                ...
                <Button
                  ...
                  className="ml-auto bg-blue-600 text-white hover:brightness-95 disabled:opacity-50"
                >
                  등록하기
                </Button>
              </div>
